;(function (global, factory) {
  ...
  function isObject(obj) {
    ...
    return (
      ...
      (obj == null
        ? void 0
        : (_obj$constructor = obj.constructor) == null
        ? void 0
      ...
      */
      const { mask = undefined, ...instanceOpts } =
        opts instanceof IMask.Masked
          ...
          : opts.mask instanceof IMask.Masked
          ? opts
          : {}
      if (mask) {
      ...
      return {
        ...
        _beforeTailState:
          ((_flags$_beforeTailSta = flags._beforeTailState) == null
            ? void 0
            : _flags$_beforeTailSta.masked) || flags._beforeTailState,
      }
    }
  }
  ...
  */
  class MaskedPattern extends Masked {
    ...
    _appendEager() {
      ...
      const details = new ChangeDetails()
      let startBlockIndex =
        (_this$_mapPosToBlock = this._mapPosToBlock(this.value.length)) == null
          ? void 0
      ...
      for (let bi = blockIter.index; ; ++bi) {
        ...
        const blockDetails = block._appendChar(ch, {
          ...
          _beforeTailState:
            (_flags$_beforeTailSta = flags._beforeTailState) == null
              ? void 0
              : (_flags$_beforeTailSta2 = _flags$_beforeTailSta._blocks) == null
              ? void 0
